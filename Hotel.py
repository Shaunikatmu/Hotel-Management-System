...
def HotelManagement(userName, userId, hotelName, bookingCost, rooms, locations, ratings, prices):
    # Initialize arrays that store hotel data and user data
    hotels = []
    ...
    PrintHotelBycity("Ottawa", hotels)
...
if __name__ == '__main__':
    # Initialize variables to store hotels data and user data.
    userName = ["Mason", "Tanner", "Rose"]
    userId = [2, 3, 4]
    hotelName = ["Sheraton", "Hilton", "Marriott"]
    bookingCost = [100, 120, 110]
    rooms = [4, 5, 6]
    locations = ["Ottawa", "Ottawa", "Montreal"]
    ratings = [5, 5, 3]
    prices = [100, 200, 100]
